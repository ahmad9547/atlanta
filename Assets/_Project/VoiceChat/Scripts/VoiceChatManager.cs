...
namespace VoiceChat
{
    public sealed class VoiceChatManager : MonoBehaviourPunCallbacks
    {
        ...
        private void JoinedAdminVoiceChat()
        {
            ...
            MicrophoneStateController microphoneStateController = GameObject.FindObjectOfType<MicrophoneStateController>();
            if (microphoneStateController != null)
            {
                microphoneStateController.SetupMicrophone();
            }
        }
