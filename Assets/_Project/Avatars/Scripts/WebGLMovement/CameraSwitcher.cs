...
namespace Avatars.WebGLMovement
{
    public sealed class CameraSwitcher : MonoBehaviour
    {
        ...
        [SerializeField] public CinemachineVirtualCamera crouchCamera;
        ...
        private void Update()
        {
            //if(Input.GetKeyDown(KeyCode.V) && !CameraSwitchInTunner.IsInTunnel)
            //{
            //    OnCameraSwitchInput();
            //}
        }
        ...
        public void OnCameraSwitchInput()
        {
            isThirdPerson = !isThirdPerson;
            ToggleViewCamera(isThirdPerson);
        }
