...
namespace PaintCore
{
	...
	public class CwDestroyer : MonoBehaviour, IHitPoint, IHitLine, IHitQuad
	{
		...
		public void HandleHitLine(bool preview, int priority, float pressure, int seed, Vector3 positionA, Vector3 positionB, Quaternion rotation, bool clip, string name = "")
		{
			DestroyNow();
		}
